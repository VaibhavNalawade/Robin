...
@Composable
fun AddressAndPhoneDetails(navController: NavHostController, viewModel: AccountSharedViewModel) {
...
fun AddressAndPhoneDetailsPreview() {
    RobinAppPreviewScaffold {
        AddressAndPhoneDetails(NavHostController(LocalContext.current), AccountSharedViewModel())
    }
}